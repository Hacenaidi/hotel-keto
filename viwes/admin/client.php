...
$n = $listres->rowCount();
$listclient = $controller->countusers() ;
                ...
                <div class="container-fluid">
                 ...
                 <thead class="table-dark">
                     ...
                     $i = 0; while($l = $listclient->fetch()){ ?>
                       ...
                       <td><?php echo $l[7]?></td>
                       <td><?php echo $l[5]?></td>
                   <td><?php echo "<a href='deleteuser.php?id=$l[0]'><button type='button' class='btn btn-danger'><i class='glyphicon glyphicon-remove'></i></button></a>" ;
