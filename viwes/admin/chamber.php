...
$listchamber = $controller->listchamber();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Chamber addition</h1>
                    </div>
                    <div class="row" >
                    <div class="col-xl-12 col-lg-12 card shadow" style="padding : 20px;margin:5px">
                    <form class="row g-3 needs-validation" action="insertionchamber.php" method="POST" enctype="multipart/form-data">
                  <div class="col-md-4">
                    <label for="validationCustom01" class="form-label">name</label>
                        <input type="text" class="form-control" id="validationCustom01" value="Premium King" name="name" required>
                        <div class="valid-feedback">
                      Looks good!
                    </div>
                    </div>
                    <div class="col-md-4">
                          <label for="validationCustom02" class="form-label">Number of places</label>
                <input type="number" class="form-control" id="validationCustom02" value="1" name="nb_place" required>
                <div class="valid-feedback">
                Looks good!
                </div>
            </div>
            ...
            <label for="validationCustomUsername" class="form-label">Prix</label>
                ...
                <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="prix" required>
                ...
                <div class="col-md-5">
                    <label for="validationCustom03" class="form-label">Room number</label>
                    <input type="number" class="form-control" id="validationCustom03" name="num" required >
                    <div class="invalid-feedback">
                    ...
                    <label class="form-label" for="inputGroupFile0">Upload</label>
                    <input type="hidden" name="MAX_FILE_SIZE" value="2079596" />
                    <input type="file" class="form-control" id="inputGroupFile01" name="fileupload" required>
                    ...
                    <div class="col-12">
                        <br>
                        <button class="btn btn-primary" type="submit">Chamber addition</button>
                    </div>
                    </form>
                    </div>
                ...
                <div class="col-xl-12 col-lg-12 card shadow" style="padding : 20px;margin:5px">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="padding-top : 14px">
                        <h1 class="h3 mb-0 text-gray-800"> List chamber</h1>
                    </div>  
             ...
             <table class="table">
                 <thead class="table-dark">
                   ...
                   <?php
                     if ($l[5] == 0){
                    echo " <a href='updatechamber.php?id=$l[0]&val=1'>
                    <button type='button' class='btn btn-danger'>NO</button></a>";
                    }else{
                    echo"
                       <a href='updatechamber.php?id=$l[0]&val=0'>
                       <button type='button' class='btn btn-info'>Yes</button></a>";
                      }
                      ?>
                   </td>
                   <td><?php echo "<a href='modifychamber.php?id=$l[0]'   style='margin-right: 10px;' ><button type='button' class='btn btn-success'>Modify</button></a>" ;
                             echo "<a href='deletechamber.php?id=$l[0]'><button type='button' class='btn btn-danger'>Delete</button></a>"
                             ?></td>
                                </tr>
                     <?php $i++;} ?>
                    </tbody>
