...
$earingsmonthly = $controller->EarningsMonthly()[0];
$EARNINGSANNUAL = $controller->EARNINGSANNUAL()[0];
$datareservation = $controller->datareservation();
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">DT <?php echo $earingsmonthly ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Earnings (Annual)</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">DT <?php echo $EARNINGSANNUAL ?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Useurs
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $reservationrequeste ?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i>  Accept
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Wating
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Refuse
                                        </span>
                                    </div>
                                </div>
                            </div>
...
var myPieChart = new Chart(ctxp, {
  type: 'doughnut',
  data: {
    labels: ["Accept", "Wating", "Refuse"],
    datasets: [{
      data: [
        <?php 
        $data = [0 ,0 ,0 ];
        while($l = $datareservation->fetch()){ 
            if ( $l[0] == 1){
                $data[0] = $l[1];
            }else{
                if($l[0] == 0){
