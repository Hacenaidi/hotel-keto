...
$n = $listres->rowCount();
$countuser = $controller->countusers()->rowCount() ;
...
$chamber = $controller->getchamber($id);
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Chamber Modifiy</h1>
                    </div>
                    <div class="row" >
                    <div class="col-xl-12 col-lg-12 card shadow" style="padding : 20px;margin:5px">
                    <form class="row g-3 needs-validation" action="modify_action_chamber.php" method="POST" enctype="multipart/form-data">
                  <div class="col-md-4">
                    <label for="validationCustom01" class="form-label">name</label>
                        <input type="text" class="form-control" id="validationCustom01" value="<?php echo $chamber[1] ?>" name="name" required>
                ...
                <input type="number" class="form-control" id="validationCustom02" value="<?php echo $chamber[3] ?>" name="nb_place" required>
                <div class="valid-feedback">
                Looks good!
                </div>
            </div>
            ...
            <label for="validationCustomUsername" class="form-label">Prix</label>
                ...
                <input type="text" class="form-control" id="validationCustomUsername" value="<?php echo $chamber[2] ?>" aria-describedby="inputGroupPrepend" name="prix" required>
                ...
                <div class="col-md-5">
                    ...
                    <input type="number" class="form-control" id="validationCustom03" name="num" required value="<?php echo $chamber[6] ?>" >
                    <div class="invalid-feedback">
                    ...
                    <input type="hidden" name="nameimage" value="<?php echo $chamber[4] ?>" />
                    <input type="hidden" name="MAX_FILE_SIZE" value="2079596" />
                    <input type="file" class="form-control" id="inputGroupFile01" name="file">
                    <input type="hidden" name="id" value="<?php echo $chamber[0] ?>" />
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        <br>
                        <button class="btn btn-primary" type="submit">Chamber Modifiy</button>
                    </div>
                    </form>
                    </div>
