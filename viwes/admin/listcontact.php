...
$listcontactreding = $controller->listcontact("");
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-flex">
                    ...
                    <div class="ml-auto p-2"><a href="toutcontact.php"><button type="button" class="btn btn-success">Tous</button></a></div>
                    </div>
                    <div class="row" >
  ...
  <tbody class="border-left-primary">
    ...
    <tr>
      ...
      <td><?php echo $l[4] ?></td>
      <td>
      <a href="updatecontact.php?id=<?php echo $l[0] ?>" class="badge badge-info">Reding</a></td>
    </tr>
    <?php 
$i++;}?>
  </tbody>
