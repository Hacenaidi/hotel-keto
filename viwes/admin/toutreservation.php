...
$reservation = $controller->toutreservation();
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="ml-auto p-2"><a href="listreservation.php"><button type="button" class="btn btn-danger">Retour</button></a></div>
                    </div>
  ...
  <tbody>
    ...
    echo "<button type='button' class='btn btn-danger ' disabled>denied</button>";
