...
$listcontactreding = $controller->toutcontact();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-flex">
                    ...
                    <div class="ml-auto p-2"><a href="listcontact.php"><button type="button" class="btn btn-danger">Retour</button></a></div>
                    </div>
                    <div class="row" >
                    <div class="col-xl-12 col-lg-12 card shadow" style="padding : 20px;margin:5px">
                    
                    <table class="table table-striped border-left-dark">
  <thead>
    <tr>
      <th scope="col">#</th>
      ...
      <th scope="col">Reding</th>
    </tr>
  </thead>
  <tbody class="border-left-primary">
    <?php $i = 0;
    while($l = $listcontactreding->fetch()){
    ?>
    <tr>
...
<?php 
if ($l[5] == 0){
    echo "<button type='button' class='btn btn-danger ' disabled style='size:10px'>Not Reding</button>";
}else{
    echo "<button type='button' class='btn btn-success' disabled>Reding</button>";
