...
$listoffer = $controller->offerdonner($id)->fetch();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Offer Modify</h1>
</div>
<div class="row" >
<div class="col-xl-12 col-lg-12 card shadow" style="padding : 20px;margin:5px">
<form class="row g-3 needs-validation" action="modify_action_offer.php" method="POST" enctype="multipart/form-data">
<div class="col-md-6">
...
<label for="validationCustom01" class="form-label">chamber</label><br>
  ...
  while($l = $listchamber->fetch()){
    if ($listoffer[2] == $l[0]){
        echo "<option value='$l[0]' selected >$l[6]</option>";
    }else{
...
<input type="number" class="form-control" id="validationCustom02" value="<?php echo $listoffer[1] ?>" name="validite" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
...
<input type="number" class="form-control" id="validationCustom02" value="<?php echo $listoffer[3] ?>" name="pct" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
...
<div class="col-12">
    <br>
    <button class="btn btn-primary" type="submit">Offer Modify</button>
</div>
</form>
</div>
