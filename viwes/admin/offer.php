...
$res = $controller->listadmin($idadmin)->fetch();
...
$listoffer = $controller->listoffer();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Offer addition</h1>
</div>
<div class="row" >
<div class="col-xl-12 col-lg-12 card shadow" style="padding : 20px;margin:5px">
<form class="row g-3 needs-validation" action="insertionoffer.php" method="POST" enctype="multipart/form-data">
<div class="col-md-6">
<label for="validationCustom01" class="form-label">chamber</label><br>
    <!-- <input type="text" class="form-control" id="validationCustom01" value="Premium King" name="name" required> -->
  <select class="form-control" aria-label="Default select example" id="validationCustom01" name="list">
  <option selected value="0">chamber numero</option>
  <?php
  while($l = $listchamber->fetch()){
    echo "<option value='$l[0]'>$l[6]</option>";
  }
  ?>
</select>
...
<div class="col-md-6">
      <label for="validationCustom02" class="form-label">Validite</label>
<input type="number" class="form-control" id="validationCustom02" value="1" name="validite" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
...
<input type="number" class="form-control" id="validationCustom02" value="1" name="pct" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
...
<div class="col-12">
    <br>
    <button class="btn btn-primary" type="submit">Offer addition</button>
</div>
</form>
</div>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4" style="padding-top : 14px">
    <h1 class="h3 mb-0 text-gray-800"> List Offers</h1>
</div>  
...
<thead class="table-dark">
 ...
 $i = 1; while($l = $listoffer->fetch()){ ?>
   ...
   <td>
    <?php 
    $prix = $l[5] - ($l[5] * $l[3])/100;
    echo $prix;
    ?>
</td>
<td><?php echo "<a href='modifyoffer.php?id=$l[0]' style='  margin-right: 10px;'><button type='button' class='btn btn-success'>Modify</button></a>" ;
         echo "<a href='deleteoffer.php?id=$l[0]'><button type='button' class='btn btn-danger'>Delete</button></a>"
         ?></td>
            </tr>
 <?php $i++;} ?>
</tbody>
